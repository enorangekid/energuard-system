...
/* 원본 엑셀(아이소핑크.xlsx)의 판매가 행 전부 — "행 추가"로 직접 다 넣지 않아도
   ...
   marginPct(참고마진 %)는 엑셀의 "참고마진" 열 값 그대로임 — 처음엔 "순수마진율"
   (실제 판매가가 달성하던 값)을 잘못 넣었었는데, 사용자가 "참고마진이 그
   참고마진이 아니네"라고 지적해서 바로잡음(2026-09-04). 참고마진은 원가 인상 등
   나중에 단가 조정할 때 참고하려고 만들어둔 목표치라, 실제 판매가와 정확히
   일치하지 않는 게 정상 — 지금 자동계산된 판매가가 원본 엑셀 판매가와 달라지는
   행이 있는 것도 정상이다(참고마진 자체가 실제 판매가를 그대로 재현하는 값이
   아니라 "목표"이기 때문). */
const HK_ISO_SEED_ROWS = [
  { channel:'기본', product:'extruded', thickness:10, sizeKey:'430x430', qty:3, marginPct:55 },
  { channel:'기본', product:'extruded', thickness:10, sizeKey:'600x900', qty:3, marginPct:50 },
  { channel:'기본', product:'extruded', thickness:20, sizeKey:'430x430', qty:3, marginPct:55 },
  { channel:'기본', product:'extruded', thickness:20, sizeKey:'600x900', qty:1, marginPct:50 },
  { channel:'기본', product:'extruded', thickness:30, sizeKey:'430x430', qty:2, marginPct:55 },
  { channel:'기본', product:'extruded', thickness:30, sizeKey:'600x900', qty:1, marginPct:50 },
  { channel:'기본', product:'extruded', thickness:40, sizeKey:'430x430', qty:2, marginPct:55 },
  { channel:'기본', product:'extruded', thickness:40, sizeKey:'600x900', qty:1, marginPct:50 },
  { channel:'기본', product:'extruded', thickness:50, sizeKey:'430x430', qty:2, marginPct:55 },
  { channel:'기본', product:'extruded', thickness:50, sizeKey:'600x900', qty:1, marginPct:50 },
  { channel:'기본', product:'extruded', thickness:70, sizeKey:'430x430', qty:1, marginPct:55 },
  { channel:'기본', product:'extruded', thickness:70, sizeKey:'600x900', qty:1, marginPct:50 },
  { channel:'기본', product:'extruded', thickness:100, sizeKey:'430x430', qty:1, marginPct:55 },
  { channel:'기본', product:'extruded', thickness:100, sizeKey:'600x900', qty:1, marginPct:50 },
  { channel:'기본', product:'adhesive', thickness:10, sizeKey:'600x900', qty:3, marginPct:55 },
  { channel:'기본', product:'adhesive', thickness:20, sizeKey:'600x900', qty:1, marginPct:55 },
  { channel:'기본', product:'adhesive', thickness:30, sizeKey:'600x900', qty:1, marginPct:55 },
  { channel:'기본', product:'adhesive', thickness:40, sizeKey:'600x900', qty:1, marginPct:55 },
  { channel:'기본', product:'adhesive', thickness:50, sizeKey:'600x900', qty:1, marginPct:55 },
  { channel:'기본', product:'adhesive', thickness:10, sizeKey:'600x900', qty:10, marginPct:55 },
  { channel:'기본', product:'adhesive', thickness:20, sizeKey:'600x900', qty:5, marginPct:55 },
  { channel:'기본', product:'adhesive', thickness:30, sizeKey:'600x900', qty:3, marginPct:55 },
  { channel:'기본', product:'adhesive', thickness:40, sizeKey:'600x900', qty:2, marginPct:55 },
  { channel:'기본', product:'adhesive', thickness:50, sizeKey:'600x900', qty:2, marginPct:55 },
  { channel:'기본', product:'extruded', thickness:10, sizeKey:'900x1800', qty:10, marginPct:30 },
  { channel:'기본', product:'extruded', thickness:20, sizeKey:'900x1800', qty:5, marginPct:30 },
  { channel:'기본', product:'extruded', thickness:30, sizeKey:'900x1800', qty:3, marginPct:30 },
  { channel:'기본', product:'extruded', thickness:40, sizeKey:'900x1800', qty:2, marginPct:30 },
  { channel:'기본', product:'extruded', thickness:50, sizeKey:'900x1800', qty:2, marginPct:30 },
  { channel:'기본', product:'extruded', thickness:70, sizeKey:'900x1800', qty:1, marginPct:25 },
  { channel:'기본', product:'extruded', thickness:100, sizeKey:'900x1800', qty:1, marginPct:25 },
  { channel:'기본', product:'extruded', thickness:10, sizeKey:'900x1800', qty:1, marginPct:30 },
  { channel:'기본', product:'extruded', thickness:20, sizeKey:'900x1800', qty:1, marginPct:30 },
  { channel:'기본', product:'extruded', thickness:30, sizeKey:'900x1800', qty:1, marginPct:30 },
  { channel:'기본', product:'extruded', thickness:40, sizeKey:'900x1800', qty:1, marginPct:30 },
  { channel:'기본', product:'extruded', thickness:50, sizeKey:'900x1800', qty:1, marginPct:30 },
  { channel:'기본', product:'extruded', thickness:70, sizeKey:'900x1800', qty:1, marginPct:25 },
  { channel:'기본', product:'extruded', thickness:100, sizeKey:'900x1800', qty:1, marginPct:25 },
  { channel:'기본', product:'extruded', thickness:70, sizeKey:'900x1800', qty:3, marginPct:25 },
  { channel:'기본', product:'extruded', thickness:100, sizeKey:'900x1800', qty:3, marginPct:25 },
  { channel:'기본', product:'extruded', thickness:250, sizeKey:'900x1800', qty:1, marginPct:45 },
  { channel:'기본', product:'extruded', thickness:500, sizeKey:'900x1800', qty:1, marginPct:45 },
  { channel:'기본', product:'adhesive', thickness:10, sizeKey:'900x1800', qty:1, marginPct:45 },
  { channel:'기본', product:'adhesive', thickness:20, sizeKey:'900x1800', qty:1, marginPct:45 },
  { channel:'기본', product:'adhesive', thickness:30, sizeKey:'900x1800', qty:1, marginPct:45 },
  { channel:'기본', product:'adhesive', thickness:40, sizeKey:'900x1800', qty:1, marginPct:45 },
  { channel:'기본', product:'adhesive', thickness:50, sizeKey:'900x1800', qty:1, marginPct:45 },
  { channel:'기본', product:'adhesive', thickness:10, sizeKey:'900x1800', qty:10, marginPct:45 },
  { channel:'기본', product:'adhesive', thickness:20, sizeKey:'900x1800', qty:5, marginPct:45 },
  { channel:'기본', product:'adhesive', thickness:30, sizeKey:'900x1800', qty:3, marginPct:45 },
  { channel:'기본', product:'adhesive', thickness:40, sizeKey:'900x1800', qty:2, marginPct:45 },
  { channel:'기본', product:'adhesive', thickness:50, sizeKey:'900x1800', qty:2, marginPct:45 },
  { channel:'기본', product:'extruded', thickness:100, sizeKey:'600x860', qty:1, marginPct:40 },
  { channel:'기본', product:'extruded', thickness:250, sizeKey:'600x430', qty:1, marginPct:45 },
  { channel:'기본', product:'extruded', thickness:250, sizeKey:'600x860', qty:1, marginPct:45 },
  { channel:'기본', product:'extruded', thickness:500, sizeKey:'600x430', qty:1, marginPct:45 },
  { channel:'기본', product:'extruded', thickness:500, sizeKey:'600x860', qty:1, marginPct:45 },
  { channel:'쿠팡위너', product:'extruded', thickness:10, sizeKey:'600x900', qty:10, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:10, sizeKey:'600x900', qty:20, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:20, sizeKey:'600x900', qty:5, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:20, sizeKey:'600x900', qty:10, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:30, sizeKey:'600x900', qty:1, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:30, sizeKey:'600x900', qty:3, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:30, sizeKey:'600x900', qty:5, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:30, sizeKey:'600x900', qty:10, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:40, sizeKey:'600x900', qty:2, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:40, sizeKey:'600x900', qty:5, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:50, sizeKey:'600x900', qty:1, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:50, sizeKey:'600x900', qty:2, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:70, sizeKey:'600x900', qty:1, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:100, sizeKey:'600x900', qty:1, marginPct:50 },
  { channel:'쿠팡위너', product:'extruded', thickness:100, sizeKey:'600x860', qty:1, marginPct:43 },
  { channel:'쿠팡위너', product:'extruded', thickness:250, sizeKey:'600x860', qty:1, marginPct:43 },
  { channel:'쿠팡위너', product:'extruded', thickness:250, sizeKey:'600x430', qty:1, marginPct:47 },
  { channel:'쿠팡위너', product:'extruded', thickness:500, sizeKey:'600x860', qty:1, marginPct:43 },
  { channel:'쿠팡위너', product:'extruded', thickness:500, sizeKey:'600x430', qty:1, marginPct:47 },
  { channel:'쿠팡위너', product:'extruded', thickness:10, sizeKey:'900x1800', qty:10, marginPct:23 },
  { channel:'쿠팡위너', product:'extruded', thickness:20, sizeKey:'900x1800', qty:5, marginPct:24 },
  { channel:'쿠팡위너', product:'extruded', thickness:30, sizeKey:'900x1800', qty:3, marginPct:33 },
  { channel:'쿠팡위너', product:'extruded', thickness:40, sizeKey:'900x1800', qty:2, marginPct:32 },
  { channel:'쿠팡위너', product:'extruded', thickness:50, sizeKey:'900x1800', qty:2, marginPct:29 },
  { channel:'쿠팡위너', product:'extruded', thickness:70, sizeKey:'900x1800', qty:1, marginPct:36 },
  { channel:'쿠팡위너', product:'extruded', thickness:100, sizeKey:'900x1800', qty:1, marginPct:28 },
];
